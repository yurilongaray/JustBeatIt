...
if (archive.prices && archive.spents && archive.supplies) {
    ...
    var kmDay_1 = [];
    var etcx_1 = [];
    spents_1.forEach(function (element) {
        kmDay_1.push({
            date: element.date,
            value: -1
        });
    ...
    kmDay_1.forEach(function (kmday) {
        spents_1.forEach(function (spent) {
            if (kmday.date === spent.date) {
                var x = (spent.value - kmday.value);
                etcx_1.push({
                    date: kmday.date,
                    value: x
                });
